...
<form class="busca" method="get" style="margin-bottom:16px">
    <input type="text" name="busca" placeholder="Buscar por recurso ou usuário..." value="<?= e($busca) ?>">
    <button class="btn btn-cinza">Buscar</button>
</form>
<table>
    <thead><tr><th>Recurso</th><th>Usuário</th><th>Data</th><th>Turno</th><th>Origem</th><th>Status</th></tr></thead>
    <tbody>
    <?php if (!$lista): ?>
